/**
 * Deploy the Shadow Payroll contract to a Midnight network (undeployed by
 ...
 *
 * Adapted from the deploy flow proven out in the midnight-newmoon (Level
 * 1/2) project -- same DUST-registration retry logic, proof-server wait,
 * and wallet-state persistence, pointed at the payroll contract instead.
 */
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy Shadow Payroll to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  console.log('  Next: build the allowlist (npm run build-allowlist), then npm run cli to fund it.\n');
}
