// Orchestrator for `npm run setup`: brings up the services this network
// needs, compiles the contract, then deploys it.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up Shadow Payroll on network: ${network}\n\n`);
